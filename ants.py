        ...
        if insect.is_ant:
            ...
            if self.ant is None:
                ...
                if self.ant.can_contain(insect):
                    place_ant.contain_ant(insect)
                elif insect.can_contain(self.ant):
                    insect.contain_ant(place_ant)
                    self.ant = insect
                else:
        ...
        if insect.is_ant:
            ...
            if isinstance(insect, QueenAnt):
                if insect.mainqueen:
                    ...
                    if insect.place.ant.container:
                        if insect.place.ant.ant:
                            insect.place.ant.ant = None
                    else:
                        insect.place.ant = None
...
class Insect(object):
    ...
    def reduce_armor(self, amount):
        ...
        self.armor -= amount
        if self.armor <= 0:
            if isinstance(self, QueenAnt) and self.mainqueen:
                bees_win()
            else:
...
class Bee(Insect):
    ...
    def blocked(self):
        ...
        # BEGIN Problem 6A
        "*** REPLACE THIS LINE ***"
        place_ant = self.place.ant
        if (not place_ant) or (place_ant and not place_ant.blocks_path):
            return False
        else:
            return True
        # END Problem 6A
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        while not n_place is hive and counter >= self.min_range and counter <= self.max_range:
            counter += 1
            if n_place.bees:
                return random_or_none(n_place.bees)
            n_place = n_place.entrance
        return None
        # END Problem 3B
...
class FireAnt(Ant):
    """FireAnt cooks any Bee in its Place wh:en it expires."""
    ...
    def reduce_armor(self, amount):
        ...
        # BEGIN Problem 4A
        "*** REPLACE THIS LINE ***"
        common_place = self.place
        bees_in_place = common_place.bees
...
class NinjaAnt(Ant):
    ...
    def action(self, colony):
        ...
        "*** REPLACE THIS LINE ***"
        place = self.place
        bees_in_place = place.bees
        i = len(bees_in_place) -1
        while i>=0:
            bees_in_place[i].reduce_armor(self.damage)
            i-=1
    # END Problem 6A
...
class HungryAnt(Ant):
    ...
    def action(self, colony):
        ...
        if self.digesting:
            ...
            place = self.place
            bee_copy = place.bees[:]
            poor_bee = random_or_none(bee_copy)
...
class QueenAnt(ScubaThrower):
    ...
    def action(self, colony):
        ...
        if self.mainqueen:
            ...
            while place != None:
                if place.ant and place.ant not in self.double_damage_lst:
                    place.ant.damage*=2
                    self.double_damage_lst+=[place.ant]
                if place.ant and place.ant.container:
                    contained_ant = place.ant.ant
                    if contained_ant and contained_ant not in self.double_damage_lst:
                        contained_ant.damage*=2
                        self.double_damage_lst+=[contained_ant]
                place = place.exit
